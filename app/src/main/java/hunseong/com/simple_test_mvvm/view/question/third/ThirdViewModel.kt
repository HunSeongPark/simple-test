package hunseong.com.simple_test_mvvm.view.question.third
        ...
        when (buttonType) {
            ButtonType.DEPRESSED -> {
                ...
                preferenceManager.setInt(AppPreferenceManager.KEY_EXCITED_PERCENT,
                    excitedPercent - 10)
                preferenceManager.setString(AppPreferenceManager.KEY_THIRD_ANSWER, "depressed")
            }
            ButtonType.SAD -> {
                preferenceManager.setInt(AppPreferenceManager.KEY_SAD_PERCENT, sadPercent + 5)
                preferenceManager.setInt(AppPreferenceManager.KEY_EXCITED_PERCENT,
                    excitedPercent - 5)
                preferenceManager.setString(AppPreferenceManager.KEY_THIRD_ANSWER, "sad")
            }
            ButtonType.GOOD -> {
                preferenceManager.setInt(AppPreferenceManager.KEY_SAD_PERCENT, sadPercent - 5)
                preferenceManager.setInt(AppPreferenceManager.KEY_EXCITED_PERCENT,
                    excitedPercent + 5)
                preferenceManager.setString(AppPreferenceManager.KEY_THIRD_ANSWER, "good")
            }
            ButtonType.EXCITED -> {
                preferenceManager.setInt(AppPreferenceManager.KEY_SAD_PERCENT, sadPercent - 10)
                preferenceManager.setInt(AppPreferenceManager.KEY_EXCITED_PERCENT,
                    excitedPercent + 10)
                preferenceManager.setString(AppPreferenceManager.KEY_THIRD_ANSWER, "excited")
            }
        }
