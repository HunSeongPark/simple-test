...
import hunseong.com.simple_test_mvvm.databinding.FragmentThirdBinding
...
class ThirdFragment : BaseFragment<ThirdViewModel, FragmentThirdBinding>() {
    ...
    override fun getViewBinding(): FragmentThirdBinding =
    ...
    override fun observeData() = viewModel.processLiveData.observe(viewLifecycleOwner) {
        when (it) {
            ...
            is ProcessState.Success -> showFragment(FourthFragment.newInstance(),
                FourthFragment.TAG)
        }
